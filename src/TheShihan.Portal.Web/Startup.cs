    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<AuthorizationOptions>(options => {
                options.AddPolicy("AdminAccess", policy => policy.RequireClaim("http://schemas.microsoft.com/ws/2008/06/identity/claims/role", "Administrator"));
                options.AddPolicy("ReadAccess", policy => policy.RequireClaim("http://schemas.microsoft.com/ws/2008/06/identity/claims/role", "Administrator", "Visitor", "Editor", "Moderator", "Author", "Contributor"));
            });
